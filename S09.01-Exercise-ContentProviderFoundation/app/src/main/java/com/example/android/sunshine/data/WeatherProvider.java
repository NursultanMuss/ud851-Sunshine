...
//  TODO (7) Instantiate a static UriMatcher using the buildUriMatcher method
    ...
    public static UriMatcher buildUriMatcher (){
        ...
        sUriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY, WeatherContract.PATH_WEATHER, CODE_WEATHER);
        sUriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
